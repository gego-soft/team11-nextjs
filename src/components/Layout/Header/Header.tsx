            ...
            <div className="relative">
              ...
              {showDropdown && (
                <div className="absolute top-full right-0 mt-2 bg-white rounded-lg shadow-lg min-w-37.5 overflow-hidden z-50">
                  ...
                  <button
                    className="block w-full px-4 py-3 text-left text-slate-700 hover:bg-slate-100 hover:text-yellow-600 transition-colors text-sm font-medium border-none bg-none cursor-pointer"
